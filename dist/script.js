...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_tabs_js__WEBPACK_IMPORTED_MODULE_2__["default"])('.glazing_slider ', '.glazing_block', '.glazing_content', 'active');
  Object(_modules_tabs_js__WEBPACK_IMPORTED_MODULE_2__["default"])('.decoration_slider', '.no_click', '.decoration_content > div > div', 'after_click');
...
var forms = function forms() {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            _context.next = 5;
            return regeneratorRuntime.awrap(status.text());
  ...
  form.forEach(function (form) {
    form.addEventListener("submit", function (e) {
      ...
      console.log(formData); // const json = JSON.stringify(Object.fromEntries(formData.entries()));
...
var modals = function modals() {
  function bindModal(trgSelector, closeSelector, modalSelector) {
    var trgBtns = document.querySelectorAll(trgSelector),
        modal = document.querySelector(modalSelector),
        closeBtns = document.querySelectorAll(closeSelector);
    trgBtns.forEach(function (btn) {
  ...
  bindModal(".phone_link", ".popup_close", ".popup"); // bindModalwithTime(".popup", 60000);
};
